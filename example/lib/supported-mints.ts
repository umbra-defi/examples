...
// mainnet additions happen out-of-band. Use this only for offline dev
...
//
// Supported-mint list (from `src/protocol/constants/supported-mints.ts`):
//   - Mainnet (5): wSOL, USDC, USDT, UMBRA, CASH
//   - Devnet  (3): wSOL, dUSDC, dUSDT  (faucet: https://faucet.umbraprivacy.com/)
//   - Localnet (1): wSOL

import type { UmbraRelayer } from "@umbra-privacy/sdk";
...
export const FALLBACK_MINTS: readonly SupportedMint[] = [
  ...
  { mint: "PRVT6TB7uss3FrUd2D9xs2zqDBsa3GbMJMwCQsgmeta",  symbol: "UMBRA", decimals: 6, network: "mainnet-beta" },
  { mint: "CASHx9KJUStyftLFWGvEVf59SGeG9sh5FfcnZMVPCASH", symbol: "CASH", decimals: 6, network: "mainnet-beta" },
  // Devnet — V18 supports wSOL + dUSDC + dUSDT. Get test tokens at
  // https://faucet.umbraprivacy.com/ (1,000 per wallet per 60 min, no signup).
  // Always confirm with relayer.getSupportedMints() before relying on this list.
  { mint: "So11111111111111111111111111111111111111112",  symbol: "wSOL",  decimals: 9, network: "devnet" },
...
export async function fetchLiveSupportedMints(relayer: UmbraRelayer): Promise<Set<string>> {
